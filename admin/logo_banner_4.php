...
$logo_types = [
    'logo_banner_4' => ['name' => 'Logo Banner 4 (Agenda Esportiva)', 'fixed_filename' => 'logo_banner_4'],
];

$current_logo_key = 'logo_banner_4'; // Sempre usar a chave específica para o tema 4
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            if (in_array($file['type'], $allowedTypes)) {
                ...
                if (move_uploaded_file($file['tmp_name'], $destination)) {
                    ...
                    if ($userImage->saveUserImage($userId, $posted_logo_type, $imagePath, 'file')) {
                        ...
                        $successMessage = "Logo para banners do Tema 4 atualizado com sucesso! Cache de banners limpo automaticamente ({$removedCount} arquivos removidos).";
                    } else {
    ...
    if (!empty($successMessage) || !empty($errorMessage)) {
        ...
        header("Location: logo_banner_4.php");
        exit();
    }
}
...
<div class="page-header">
    <h1 class="page-title">
        ...
        Logo para Banner Tema 4 (Agenda Esportiva)
    </h1>
    <p class="page-subtitle">Configure o logo utilizado nos banners do Tema 4</p>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p class="card-subtitle">Prévia do logo atual para o Tema 4</p>
        </div>
        <div class="card-body">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li class="flex items-center gap-2">
                        <i class="fas fa-check text-success-500"></i>
                        Aparece no canto superior esquerdo dos banners
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fas fa-check text-success-500"></i>
                        Tamanho recomendado: 180px de largura
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li class="flex items-center gap-2">
                        <i class="fas fa-lightbulb text-warning-500"></i>
                        Prefira logos horizontais para este tema
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fas fa-lightbulb text-warning-500"></i>
